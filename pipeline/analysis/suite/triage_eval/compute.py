...
This module contains the primary computation routine (no file I/O):
- :func:`compute_triage_eval`

To keep this file under the project's ~300 LOC preference, the implementation
delegates:
- per-case table building + macro/micro bookkeeping to :mod:`compute_tables`
- shared helpers/types + delta computation to :mod:`compute_core`
"""
